...
class VisionController:
    ...
    def get_mu_adjustment(self, camera_image, current_section, current_speed_kmh, current_waypoint_idx):
        ...
        #difficult regions
        if 800 <= current_waypoint_idx <= 890 or 3450 <= current_waypoint_idx <= 3510 or 630 <= current_waypoint_idx <= 740 or 6170 <= current_waypoint_idx <= 6230 or 3630 <= current_waypoint_idx <= 3710 or 6920 <= current_waypoint_idx <= 6970 or 4180 <= current_waypoint_idx <= 4280: #Sharp turn before long straight
            return 0.97
